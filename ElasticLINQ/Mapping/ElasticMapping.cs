...
namespace ElasticLinq.Mapping
{
    ...
    public class ElasticMapping : IElasticMapping
    {
	    ...
	    private bool useFullTypeNameForDocumentType;
		...
		public ElasticMapping(bool camelCaseFieldNames = true,
							 ...
							 bool useFullTypeNameForDocumentType = false,
							 ...
							 CultureInfo conversionCulture = null)
		{
	        ...
	        this.useFullTypeNameForDocumentType = useFullTypeNameForDocumentType;
        ...
        public virtual string GetDocumentType(Type type)
        {
	        ...
	        if (useFullTypeNameForDocumentType)
	        {
