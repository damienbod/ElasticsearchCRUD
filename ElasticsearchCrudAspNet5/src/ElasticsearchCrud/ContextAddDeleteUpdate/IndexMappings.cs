...
namespace ElasticsearchCRUD.ContextAddDeleteUpdate
{
    public class IndexMappings
    {
        ...
        private void IndexCreateCreatePropertyMappingForChildDocument(ElasticsearchCrudJsonWriter elasticsearchCrudJsonWriter, EntityContextInfo entityInfo, ElasticsearchMapping elasticsearchMapping, EntityContextInfo item, MappingDefinition mappingDefinition)
        {
            var childMapping =
