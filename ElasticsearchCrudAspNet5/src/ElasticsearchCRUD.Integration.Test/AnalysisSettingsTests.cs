...
namespace ElasticsearchCRUD.Integration.Test
{
    ...
    public class AnalysisSettingsTests : IDisposable
    {
		...
		public void CreateNewIndexDefinitionForPatternAnalyzer()
		{
			...
			using ( var context = new ElasticsearchContext(ConnectionString, new ElasticsearchSerializerConfiguration(_elasticsearchMappingResolver)))
			{
				...
				Thread.Sleep(1500);
				Assert.True(context.IndexExists<TestSettingsIndex>());
			}
		...
		public void CreateNewIndexDefinitionForDfrSimilarity()
		{
			...
			using (var context = new ElasticsearchContext(ConnectionString, new ElasticsearchSerializerConfiguration(_elasticsearchMappingResolver)))
			{
				...
				Thread.Sleep(1500);
				Assert.True(context.IndexExists<TestDfrSimilarity>());
		...
		public void CreateNewIndexDefinitionForBm25Similarity()
		{
			...
			using (var context = new ElasticsearchContext(ConnectionString, new ElasticsearchSerializerConfiguration(_elasticsearchMappingResolver)))
			{
				...
				Thread.Sleep(1500);
				Assert.True(context.IndexExists<TestBm25Similarity>());
