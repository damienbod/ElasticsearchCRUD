...
namespace ElasticsearchCRUD.Integration.Test.AggregationTests
{
    public class SearchAggStructureTests : SetupSearchAgg, IDisposable
    {
        ...
        {
            var search = new Search { Size = 0, Aggs = new List<IAggs>{ new MinMetricAggregation("test_min", "lift") }};
        ...
        {
            var search = new Search { Size = 0, Aggs = new List<IAggs>{ new MaxMetricAggregation("test_max", "lift") }};
        ...
        {
            var search = new Search { Size = 0, Aggs = new List<IAggs>{ new SumMetricAggregation("test_sum", "lift") }};
        ...
        {
            var search = new Search { Size = 0, Aggs = new List<IAggs>{ new AvgMetricAggregation("test_avg", "lift") }};
        ...
        {
            var search = new Search { Size = 0, Aggs = new List<IAggs>{ new StatsMetricAggregation("test_StatsAggregation", "lift") }};
        ...
        {
            var search = new Search { Size = 0, Aggs = new List<IAggs>{ new ValueCountMetricAggregation("test_ValueCountAggregation", "lift") }};
        ...
        {
            var search = new Search { Size = 0, Aggs = new List<IAggs> { new PercentilesMetricAggregation("test_PercentilesMetricAggregation", "lift") } };
        ...
        public void SearchAggGeoBoundsMetricAggregationNoHits()
        {
            ...
            using (var context = new ElasticsearchContext(ConnectionString, ElasticsearchMappingResolver))
            {
                ...
                Assert.Equal(32.0, Math.Round(aggResult.BoundsTopLeft[0]));
                Assert.Equal(45.0, Math.Round(aggResult.BoundsTopLeft[1]));
            }
        }
