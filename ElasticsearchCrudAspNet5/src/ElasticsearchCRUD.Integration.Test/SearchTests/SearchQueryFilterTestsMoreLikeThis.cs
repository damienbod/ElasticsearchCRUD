...
{
    public class SearchQueryFilterTestsMoreLikeThis : IDisposable
    {
        public SearchQueryFilterTestsMoreLikeThis()
        {
            Setup();
        }
	    ...
	    public void SearchQueryMoreLikeThisQuery()
	    {
		    ...
		    using (var context = new ElasticsearchContext(ConnectionString, ElasticsearchMappingResolver))
		    {
			    ...
			    Assert.True(context.IndexTypeExists<MoreLikeThisTestDto>());
