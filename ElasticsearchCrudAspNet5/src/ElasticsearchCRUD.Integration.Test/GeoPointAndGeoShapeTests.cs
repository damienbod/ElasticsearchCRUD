    ...
    public class GeoPointAndGeoShapeTests : IDisposable
    {
		...
		public void CreateGeoPointMapping()
		{
			...
			using ( var context = new ElasticsearchContext(ConnectionString, new ElasticsearchSerializerConfiguration(_elasticsearchMappingResolver)))
			{
				...
				Thread.Sleep(1500);
				Assert.NotNull(context.IndexExists<GeoPointDto>());

				context.AddUpdateDocument(geoPointDto, geoPointDto.Id);
				context.SaveChanges();
				Thread.Sleep(1500);
				Assert.Equal(1, context.Count<GeoPointDto>());
				var result = context.SearchById<GeoPointDto>(1);
				Assert.Equal(geoPointDto.CityCoordinates.Count, result.CityCoordinates.Count);
			}
		}
		...
		public void CreateGeoShapePointMapping()
		{
			...
			using (var context = new ElasticsearchContext(ConnectionString, new ElasticsearchSerializerConfiguration(_elasticsearchMappingResolver)))
			{
				...
				Thread.Sleep(1500);
				Assert.NotNull(context.IndexExists<GeoShapePointDto>());

				context.AddUpdateDocument(geoShapePointDto, geoShapePointDto.Id);
				context.SaveChanges();
				Thread.Sleep(1500);
				Assert.Equal(1, context.Count<GeoShapePointDto>());
				var result = context.SearchById<GeoShapePointDto>(1);
				Assert.Equal(geoShapePointDto.ShapeCityCoordinates.Coordinates.Count, result.ShapeCityCoordinates.Coordinates.Count);
			}
		}
		...
		public void CreateGeoShapeLineStringMapping()
		{
			...
			using (var context = new ElasticsearchContext(ConnectionString, new ElasticsearchSerializerConfiguration(_elasticsearchMappingResolver)))
			{
				...
				Thread.Sleep(1500);
				Assert.NotNull(context.IndexExists<GeoShapeLineStringDto>());

				context.AddUpdateDocument(geoShapeLineStringDto, geoShapeLineStringDto.Id);
				context.SaveChanges();
				Thread.Sleep(1500);
				Assert.Equal(1, context.Count<GeoShapeLineStringDto>());
				var result = context.SearchById<GeoShapeLineStringDto>(1);
				Assert.Equal(geoShapeLineStringDto.ShapeLineCoordinates.Coordinates.Count, result.ShapeLineCoordinates.Coordinates.Count);
			}
		}
		...
		public void CreateGeoShapePolygonMapping()
		{
			...
			using (var context = new ElasticsearchContext(ConnectionString, new ElasticsearchSerializerConfiguration(_elasticsearchMappingResolver)))
			{
				...
				Thread.Sleep(1500);
				Assert.NotNull(context.IndexExists<GeoShapePolygonDto>());

				context.AddUpdateDocument(geoShapePolygonDto, geoShapePolygonDto.Id);
				context.SaveChanges();
				Thread.Sleep(1500);
				Assert.Equal(1,context.Count<GeoShapePolygonDto>());
				var result = context.SearchById<GeoShapePolygonDto>(1);
				Assert.Equal(geoShapePolygonDto.Coordinates.Coordinates.Count, result.Coordinates.Coordinates.Count);
			}
		}
		...
		public void CreateGeoShapeMultiPointMapping()
		{
			...
			using (var context = new ElasticsearchContext(ConnectionString, new ElasticsearchSerializerConfiguration(_elasticsearchMappingResolver)))
			{
				...
				Thread.Sleep(1500);
				Assert.NotNull(context.IndexExists<GeoShapeMultiPointDto>());

				context.AddUpdateDocument(geoShapeLineStringDto, geoShapeLineStringDto.Id);
				context.SaveChanges();
				Thread.Sleep(1500);
				Assert.Equal(1, context.Count<GeoShapeMultiPointDto>());
				var result = context.SearchById<GeoShapeMultiPointDto>(1);
				Assert.Equal(geoShapeLineStringDto.Coordinates.Coordinates.Count, result.Coordinates.Coordinates.Count);
			}
		}
		...
		public void CreateGeoShapeMultiLineStringMapping()
		{
			...
			using (var context = new ElasticsearchContext(ConnectionString, new ElasticsearchSerializerConfiguration(_elasticsearchMappingResolver)))
			{
				...
				Thread.Sleep(1500);
				Assert.NotNull(context.IndexExists<GeoShapeMultiLineStringDto>());

				context.AddUpdateDocument(geoShapeMultiLineStringDto, geoShapeMultiLineStringDto.Id);
				context.SaveChanges();
				Thread.Sleep(1500);
				Assert.Equal(1, context.Count<GeoShapeMultiLineStringDto>());
				var result = context.SearchById<GeoShapeMultiLineStringDto>(1);
				Assert.Equal(geoShapeMultiLineStringDto.Coordinates.Coordinates.Count, result.Coordinates.Coordinates.Count);
			}
		}
		...
		public void CreateGeoShapeMultiPolygonMapping()
		{
			...
			using (var context = new ElasticsearchContext(ConnectionString, new ElasticsearchSerializerConfiguration(_elasticsearchMappingResolver)))
			{
				...
				Thread.Sleep(1500);
				Assert.NotNull(context.IndexExists<GeoShapeMultiPolygonDto>());

				context.AddUpdateDocument(geoShapeMultiPolygonDto, geoShapeMultiPolygonDto.Id);
				context.SaveChanges();
				Thread.Sleep(1500);
				Assert.Equal(1, context.Count<GeoShapeMultiPolygonDto>());
				var result = context.SearchById<GeoShapeMultiPolygonDto>(1);
				Assert.Equal(geoShapeMultiPolygonDto.Coordinates.Coordinates.Count, result.Coordinates.Coordinates.Count);
			}
		}
		...
		public void CreateGeoShapeEnvelopeMapping()
		{
			...
			using (var context = new ElasticsearchContext(ConnectionString, new ElasticsearchSerializerConfiguration(_elasticsearchMappingResolver)))
			{
				...
				Thread.Sleep(1500);
				Assert.NotNull(context.IndexExists<GeoShapeEnvelopeDto>());

				context.AddUpdateDocument(geoShapeEnvelopeDto, geoShapeEnvelopeDto.Id);
				context.SaveChanges();
				Thread.Sleep(1500);
				Assert.Equal(1, context.Count<GeoShapeEnvelopeDto>());
				var result = context.SearchById<GeoShapeEnvelopeDto>(1);
				Assert.Equal(geoShapeEnvelopeDto.Coordinates.Coordinates.Count, result.Coordinates.Coordinates.Count);
			}
		}
		...
		public void CreateGeoShapeCircleMapping()
		{
			...
			using (var context = new ElasticsearchContext(ConnectionString, new ElasticsearchSerializerConfiguration(_elasticsearchMappingResolver)))
			{
				...
				Thread.Sleep(1500);
				Assert.NotNull(context.IndexExists<GeoShapeCircleDto>());

				context.AddUpdateDocument(geoShapeCircleDto, geoShapeCircleDto.Id);
				context.SaveChanges();
				Thread.Sleep(1500);
				Assert.Equal(1, context.Count<GeoShapeCircleDto>());
				var result = context.SearchById<GeoShapeCircleDto>(1);
				Assert.Equal(geoShapeCircleDto.CircleTest.Coordinates.Count, result.CircleTest.Coordinates.Count);
			}
		}
		...
		public void CreateGeoShapeGeometryCollectionMapping()
		{
			...
			using (var context = new ElasticsearchContext(ConnectionString, new ElasticsearchSerializerConfiguration(_elasticsearchMappingResolver)))
			{
				...
				Thread.Sleep(1500);
				Assert.NotNull(context.IndexExists<GeoShapeGeometryCollectionDto>());

				context.AddUpdateDocument(geoShapeGeometryCollectionDto, geoShapeGeometryCollectionDto.Id);
				context.SaveChanges();
				Thread.Sleep(1500);
				Assert.Equal(1, context.Count<GeoShapeGeometryCollectionDto>());
