...
//				var test = CommandTypes.FindIndex(t => t.EndsWith(childType) && t.StartsWith("CreatePropertyMappings"));
//				if (test > 0)
//				{
...
//		//{"id":7,"d1":"p7"}
//		public void CreatePropertyMappings(string index, string indexType, string parentIdValue, string id, string content)
//		{
